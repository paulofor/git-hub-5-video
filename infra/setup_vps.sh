...
EOF
  ...
  DB_URL="jdbc:mysql://d555d.vps-kinghost.net:3306/aihubvideodb"
  DB_USER="aihubvideodb_user"
...
- Banco de dados externo: jdbc:mysql://d555d.vps-kinghost.net:3306/aihubvideodb
